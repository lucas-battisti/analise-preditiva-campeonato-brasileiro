...
Modelagem Estatística e Machine Learning para Previsão de Resultados

Autor: Lucas Battisti
...
Este projeto realiza uma **análise estatística e preditiva** de partidas do Campeonato Brasileiro com o objetivo de investigar:

- O impacto da **posse de bola** na probabilidade de vitória;
- A existência e magnitude da **vantagem do mando de campo**;
- Quais **estatísticas de jogo** são mais relevantes para explicar o resultado final.
...
- Interpretação via métricas de classificação e importância de variáveis

O foco não é apenas prever resultados, mas compreender os fatores associados à vitória sob uma perspectiva analítica.
...
Para garantir consistência analítica, foram mantidas apenas partidas presentes em **todas as bases**.
...
![png](notebook_files/notebook_82_0.png)
